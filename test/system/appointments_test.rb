...
class AppointmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Appointment" do
    ...
    fill_in "Appointment address", with: @appointment.appointment_address
    fill_in "Appointment time", with: @appointment.appointment_time
    fill_in "Doctors", with: @appointment.doctors_id
    fill_in "Patients", with: @appointment.patients_id
